...
class DCMod:
    ...
    def __init__(self):
        ...
        but1 = Button(win2, text="Save", width=12, command=DCMod.metadata_dc_list)
    ...
    def metadata_dc_list(self):
        ...
        dc_list2 = [diff_d1_dc1, diff_d1_dc2, diff_d2_dc1, diff_d2_dc2, diff_d3_dc1, diff_d3_dc2,
                    diff_d4_dc1, diff_d4_dc2]

        return dc_list1 + dc_list2
